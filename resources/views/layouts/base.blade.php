...
<body class="home-page home-01 ">
				...
				<div class="container">
					<div class="mid-section main-info-area">
						...
						<div class="wrap-logo-top left-section">
							<a href="index.html" class="link-to-home"><img src="{{ asset('assets/images/download.png')}}" alt="mercado"></a>
						</div>
			...
			<div class="coppy-right-box">
				<div class="container">
					<div class="coppy-right-item item-left">
						<p class="coppy-right-text">Copyright © 2020 Sarah. All rights reserved</p>
					</div>
	...
	<script src="https://cdn.tiny.cloud/1/sffu2h5xf76h7po7tkxubnpxb3s37zzzgot6ussim5z761sw/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
