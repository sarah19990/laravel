...
<div class="wrap-show-advance-info-box style-1 has-countdown">
    ...
    <div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false"
        ...
        data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"5"},"1200":{"items":"5"}}'>
        ...
        <div class="product product-style-2 equal-elem">
            <div class="product-thumnail">
                ...
                <div class="product-info">
                    ...
                    <div class="wrap-price"><ins><p class="product-price">£{{$sproduct->sale_price}}</p></ins> <del><p
                                class="product-price">£{{$sproduct->regular_price}}</p></del></div>
                </div>
            </div>
        </div>
        @endforeach
